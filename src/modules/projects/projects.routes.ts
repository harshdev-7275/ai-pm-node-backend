...
const projectResponseSchema = {
  ...
  properties: {
    ...
    cadenceStartDay:   { type: 'number', nullable: true },
    cadenceDuration:   { type: 'number', nullable: true },
    cadenceAutoCreate: { type: 'boolean' },
    cadenceNaming:     { type: 'string', nullable: true },
  },
}
